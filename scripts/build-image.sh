...
COREUTILS=(
    ...
    racos-clear racos-rmdir racos-free racos-du racos-ln racos-nc racos-ping racos-netstat
    rpkg-bin
)
...
BIN_LIST=(
    ...
    dig wget mount df umount sync clear rmdir free du ln nc ping netstat
