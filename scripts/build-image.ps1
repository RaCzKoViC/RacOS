...
$BinList = @("hello", "echo", "cat", "true", "false", "sh", "racterm", "racos-test", "ls", "wc", "uptime", "mkdir", "rm", "sleep", "head", "tail", "env", "basename", "dirname", "grep", "cp", "mv", "cut", "uniq", "find", "od", "ps", "sed", "awk", "id", "sort", "top", "touch", "chmod", "chown", "tee", "hexdump", "dig", "wget", "mount", "df", "umount", "mkfs_racfs=mkfs.racfs", "mkfs_fat32=mkfs.fat32", "sync", "rpkg")
$SbinList = @("init")
